...
from knowledge_gateway import metrics as prom_metrics
from knowledge_gateway.chats.models import (
    ChatCompletionRequestLogModel,
    ChatCompletionRequestStatus,
)
from knowledge_gateway.chats.repositories import ChatCompletionRequestLogRepository
from knowledge_gateway.config import settings
from knowledge_gateway.documents.services import DocumentSearchWithMetrics, DocumentService
